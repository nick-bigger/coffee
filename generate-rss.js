...
const feedConfig = {
  ...
  description: "The life and love of Austin Coffee",
  language: "en-us",
};
...
try {
  ...
  const outputDir = path.join(process.cwd(), "public", "feeds"); // Assumes 'public' folder at project root
  const outputFilePath = path.join(outputDir, "main.xml");
