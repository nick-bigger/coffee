import{j as n}from"../chunks/chunk-Cazg3JMt.js";import{c as a,L as i,a as r}from"../chunks/chunk-DQu3-qVC.js";import{M as c,r as l}from"../chunks/chunk-BwREXuXw.js";import"../chunks/chunk-CqkleIqs.js";const h=`---
...
First, on vendors. The showing this year featured an excellent mix of big Austin players and smaller shops, with a few from out of town as a bonus.`,u=`---
...
`;function y(){const e=a.c(2);let t;e[0]===Symbol.for("react.memo_cache_sentinel")?(t=[{slug:"atx-coffee-fest",title:"ATX Coffee Fest",content:h},{slug:"coffee-grounds",title:"Coffee Grounds",content:u}],e[0]=t):t=e[0];const o=t;let s;return e[1]===Symbol.for("react.memo_cache_sentinel")?(s=n.jsx(i,{children:n.jsx("article",{className:"mb-12 space-y-24",children:o.map(f)})}),e[1]=s):s=e[1],s}function f(e){return n.jsxs("section",{className:"space-y-4",children:[n.jsx("h2",{className:"text-lg font-normal mt-0",children:n.jsx(r,{href:`/articles/${e.slug}`,className:"uppercase underline underline-offset-[4px] decoration-[0.2px]",children:e.title})}),n.jsx(c,{remarkPlugins:[l],components:{a(t){return n.jsx("a",{className:"text-sm",...t})},p(t){return n.jsx("p",{className:"leading-[23px]",...t})}},children:e.content})]},e.slug)}export{y as Page};
